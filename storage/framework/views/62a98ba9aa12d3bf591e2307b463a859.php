...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', __('global.admin_dashboard')); ?> | <?php echo e(config('app.name')); ?></title>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/app.js']); ?>
</head>
<body class="bg-gray-50 dark:bg-gray-950 text-gray-800 dark:text-gray-200 transition-colors duration-300 min-h-screen" dir="<?php echo e(app()->getLocale() === 'ar' ? 'rtl' : 'ltr'); ?>">
    ...
    <div class="flex min-h-screen">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : 'translate-x-full lg:translate-x-0'"
            ...
            <div class="p-5 flex justify-between items-center border-b border-gray-150 dark:border-gray-800">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-2 hover:opacity-90 transition">
            ...
            <div class="p-4">
                <nav class="space-y-1.5">
                    ...
                    <a href="<?php echo e(route('admin.branches.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition duration-200 <?php echo e(request()->routeIs('admin.branches.*') ? 'bg-indigo-50 dark:bg-indigo-950/50 text-indigo-650 dark:text-indigo-400 font-semibold' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-900 dark:hover:text-white'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                        </svg>
                        <?php echo e(__('global.admin_branches')); ?>

                    </a>
                    <?php if(auth()->user()->isSuperAdmin()): ?>
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition duration-200 <?php echo e(request()->routeIs('admin.users.*') ? 'bg-indigo-50 dark:bg-indigo-950/50 text-indigo-650 dark:text-indigo-400 font-semibold' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-900 dark:hover:text-white'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
                        </svg>
                        <?php echo e(__('global.admin_users')); ?>

                    </a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('admin.categories.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition duration-200 <?php echo e(request()->routeIs('admin.categories.*') ? 'bg-indigo-50 dark:bg-indigo-950/50 text-indigo-650 dark:text-indigo-400 font-semibold' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-900 dark:hover:text-white'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4 6h16M4 12h16M4 18h7" />
                        </svg>
                        <?php echo e(__('global.admin_categories')); ?>

                    </a>
                    <a href="<?php echo e(route('admin.products.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition duration-200 <?php echo e(request()->routeIs('admin.products.*') ? 'bg-indigo-50 dark:bg-indigo-950/50 text-indigo-650 dark:text-indigo-400 font-semibold' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-900 dark:hover:text-white'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                        </svg>
                        <?php echo e(__('global.admin_products')); ?>

                    </a>
                    <a href="<?php echo e(route('admin.coupons.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition duration-200 <?php echo e(request()->routeIs('admin.coupons.*') ? 'bg-indigo-50 dark:bg-indigo-950/50 text-indigo-650 dark:text-indigo-400 font-semibold' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-900 dark:hover:text-white'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        ...
                        <?php echo e(__('global.admin_coupons')); ?>

                    </a>
                    <a href="<?php echo e(route('admin.orders.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition duration-200 <?php echo e(request()->routeIs('admin.orders.*') ? 'bg-indigo-50 dark:bg-indigo-950/50 text-indigo-650 dark:text-indigo-400 font-semibold' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-900 dark:hover:text-white'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                        </svg>
                        <?php echo e(__('global.admin_orders')); ?>

                    </a>
                    <a href="<?php echo e(route('admin.returns.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition duration-200 <?php echo e(request()->routeIs('admin.returns.*') ? 'bg-indigo-50 dark:bg-indigo-950/50 text-indigo-650 dark:text-indigo-400 font-semibold' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-900 dark:hover:text-white'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                        </svg>
                        <?php echo e(__('global.return_requests')); ?>

                    </a>
                    <a href="<?php echo e(route('admin.exchanges.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition duration-200 <?php echo e(request()->routeIs('admin.exchanges.*') ? 'bg-indigo-50 dark:bg-indigo-950/50 text-indigo-650 dark:text-indigo-400 font-semibold' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-900 dark:hover:text-white'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" />
                        </svg>
                        <?php echo e(__('global.admin_exchanges')); ?>

                    </a>
                    <a href="<?php echo e(route('admin.expenses.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition duration-200 <?php echo e(request()->routeIs('admin.expenses.*') ? 'bg-indigo-50 dark:bg-indigo-950/50 text-indigo-650 dark:text-indigo-400 font-semibold' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-900 dark:hover:text-white'); ?>">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <?php echo e(__('global.admin_expenses')); ?>

                    </a>
                    <a href="<?php echo e(route('admin.whatsapp.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition duration-200 <?php echo e(request()->routeIs('admin.whatsapp.*') ? 'bg-indigo-50 dark:bg-indigo-950/50 text-indigo-650 dark:text-indigo-400 font-semibold' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50 hover:text-gray-900 dark:hover:text-white'); ?>">
                        ...
                        <?php echo e(__('global.admin_whatsapp')); ?>
        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <header class="bg-white dark:bg-gray-900 shadow-sm px-3 sm:px-4 py-3 flex justify-between items-center border-b border-gray-100 dark:border-gray-800 transition overflow-visible">
                <div class="flex items-center gap-2 sm:gap-4 min-w-0">
                    ...
                    <h1 class="text-base sm:text-lg font-bold text-gray-900 dark:text-white truncate"><?php echo $__env->yieldContent('page-title'); ?></h1>
                </div>
                ...
                <div class="flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
                    ...
                    <div x-data="notifications()" x-init="init()">
                        <div class="relative cursor-pointer">
                            ...
                            <div x-show="open" @click.outside="open = false"
                                 ...
                                 class="fixed sm:absolute cursor-pointer z-50 top-14 sm:top-auto inset-x-2 sm:inset-x-auto sm:mt-2 <?php echo e(app()->getLocale() === 'ar' ? 'sm:left-0' : 'sm:right-0'); ?> w-auto sm:w-80 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 max-h-96 overflow-hidden"
                                 style="display:none">
                                <div class="p-3 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                                    <span class="text-sm font-bold text-gray-900 dark:text-white"><?php echo e(__('global.admin_notifications')); ?></span>
                                    <button x-show="unread > 0" @click="markAllRead" class="text-xs cursor-pointer text-indigo-600 dark:text-indigo-400 hover:underline flex-shrink-0"><?php echo e(__('global.admin_mark_all_read')); ?></button>
                                </div>
                                <div class="overflow-y-auto max-h-72">
                                    <div x-show="items.length === 0" class="p-6 text-center text-gray-400 text-sm" style="display:none"><?php echo e(__('global.admin_no_notifications')); ?></div>
                                ...
                                <a href="<?php echo e(route('admin.notifications.index')); ?>" class="block cursor-pointer p-3 text-center text-sm font-semibold text-indigo-600 dark:text-indigo-400 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition border-t border-gray-100 dark:border-gray-700">
                                    <?php echo e(__('global.admin_notifications_all')); ?>
                    ...
                    <div x-data="{ langOpen: false }" class="relative cursor-pointer">
                        ...
                        <div x-show="langOpen" @click.away="langOpen = false" x-transition class="absolute z-50 mt-2 <?php echo e(app()->getLocale() === 'ar' ? 'left-0' : 'right-0'); ?> w-32 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 py-2" style="display: none;">
                            <a href="<?php echo e(route('lang.switch', 'ar')); ?>" class="flex items-center justify-between px-4 py-2 text-xs font-semibold text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 <?php echo e(app()->getLocale() === 'ar' ? 'text-indigo-600 dark:text-indigo-400 font-extrabold' : ''); ?>">
                                <span>العربية</span>
                                <?php if(app()->getLocale() === 'ar'): ?> <svg class="w-3 h-3 text-indigo-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg> <?php endif; ?>
                            </a>
                            <a href="<?php echo e(route('lang.switch', 'en')); ?>" class="flex items-center justify-between px-4 py-2 text-xs font-semibold text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 <?php echo e(app()->getLocale() === 'en' ? 'text-indigo-600 dark:text-indigo-400 font-extrabold' : ''); ?>">
                                <span>English</span>
                                <?php if(app()->getLocale() === 'en'): ?> <svg class="w-3 h-3 text-indigo-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg> <?php endif; ?>
                            </a>
                        </div>
                    </div>

                    <!-- Back to Store -->
                    <a href="<?php echo e(route('home')); ?>" class="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-xs sm:text-sm font-semibold text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-950/30 transition flex-shrink-0">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                        <span class="hidden sm:inline"><?php echo e(__('global.admin_back_to_store')); ?></span>
                    </a>

                    <span class="hidden sm:inline text-sm font-semibold text-gray-700 dark:text-gray-300 flex-shrink-0"><?php echo e(auth()->user()->name); ?></span>
                    <form method="POST" action="<?php echo e(route('admin.logout')); ?>" class="m-0">
                        ...
                        <button class="p-1.5 cursor-pointer sm:px-3 sm:py-1.5 rounded-xl text-sm font-semibold transition bg-red-50 dark:bg-red-950/30 text-red-600 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-900/50">
                            ...
                            <span class="hidden sm:inline"><?php echo e(__('global.admin_logout')); ?></span>
                        </button>
                    </form>
                </div>
            </header>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('notifications', () => ({
                ...
                async fetchUnread() {
                    try {
                        const res = await fetch("<?php echo e(route('admin.notifications.unread-count')); ?>");
                ...
                async fetchItems() {
                    try {
                        const res = await fetch("<?php echo e(route('admin.notifications.index')); ?>?json=1");
                        const data = await res.json();
                ...
                async markRead(id) {
                    try {
                        await fetch("<?php echo e(url('admin/notifications')); ?>/" + id + "/read", { method: "POST", headers: { "X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>" } });
                ...
                async markAllRead() {
                    try {
                        await fetch("<?php echo e(route('admin.notifications.mark-all-read')); ?>", { method: "POST", headers: { "X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>" } });
                        this.unread = 0;
...
<?php /**PATH C:\Users\GH\Desktop\Projects\elegant-store\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>