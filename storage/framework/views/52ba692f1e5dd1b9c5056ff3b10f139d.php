...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>"
    ...
    <head>
        ...
        <title><?php echo e(config('app.name', 'Elegant Store')); ?></title>
    ...
    <body class="font-sans text-gray-900 dark:text-gray-100 bg-gray-50 dark:bg-gray-950 min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 transition-colors duration-300 px-4" dir="<?php echo e(app()->getLocale() === 'ar' ? 'rtl' : 'ltr'); ?>">
        ...
        <div class="fixed top-4 right-4 z-50 flex items-center gap-2">
            ...
            <div x-data="{ langOpen: false }" class="relative">
                ...
                <div x-show="langOpen" @click.away="langOpen = false" x-transition class="absolute right-0 mt-2 w-32 bg-white dark:bg-gray-850 rounded-xl shadow-xl border border-gray-100 dark:border-gray-750 py-1.5 z-50 text-start text-xs font-semibold" style="display: none;">
                    <a href="<?php echo e(route('lang.switch', 'ar')); ?>" class="flex items-center justify-between px-4 py-2 text-gray-700 dark:text-gray-250 hover:bg-gray-50 dark:hover:bg-gray-800 <?php echo e(app()->getLocale() === 'ar' ? 'text-indigo-650 dark:text-indigo-400 font-bold' : ''); ?>">
                        <span>العربية</span>
                        <?php if(app()->getLocale() === 'ar'): ?> <svg class="w-3.5 h-3.5 text-indigo-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg> <?php endif; ?>
                    </a>
                    <a href="<?php echo e(route('lang.switch', 'en')); ?>" class="flex items-center justify-between px-4 py-2 text-gray-700 dark:text-gray-250 hover:bg-gray-50 dark:hover:bg-gray-800 <?php echo e(app()->getLocale() === 'en' ? 'text-indigo-650 dark:text-indigo-400 font-bold' : ''); ?>">
                        <span>English</span>
                        <?php if(app()->getLocale() === 'en'): ?> <svg class="w-3.5 h-3.5 text-indigo-600" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path></svg> <?php endif; ?>
                    </a>
                </div>
            </div>
...
<?php /**PATH C:\Users\GH\Desktop\Projects\elegant-store\resources\views/layouts/guest.blade.php ENDPATH**/ ?>