        ...
        <nav class="flex text-sm text-gray-500" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 space-x-reverse md:space-x-3">
                <li class="inline-flex items-center">
                    <a href="<?php echo e(route('home')); ?>" class="hover:text-indigo-600 dark:hover:text-indigo-400"><?php echo e(__('global.home')); ?></a>
                </li>
                <li aria-current="page">
                    <div class="flex items-center">
                        <svg class="w-4 h-4 text-gray-400 mx-1 <?php echo e(app()->getLocale() === 'ar' ? 'transform rotate-180' : ''); ?>" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                        <span class="text-gray-800 dark:text-gray-200 font-semibold"><?php echo e(__('global.profile')); ?></span>
                    </div>
                </li>
            </ol>
        </nav>
...
<div class="container mx-auto px-4 mb-20">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl font-extrabold text-gray-900 dark:text-white mb-8 text-start"><?php echo e(__('global.edit_profile')); ?></h1>
        ...
        <?php if(session('status') === 'profile-updated'): ?>
            <div class="mb-6 p-4 bg-green-50 dark:bg-green-950/20 text-green-700 dark:text-green-400 rounded-lg text-sm font-semibold text-start flex items-center gap-2 border border-green-200 dark:border-green-800">
                ...
                <span><?php echo e(__('global.profile_updated')); ?></span>
            </div>
        <?php endif; ?>
        ...
        <?php if(session('status') === 'password-updated'): ?>
            <div class="mb-6 p-4 bg-green-50 dark:bg-green-950/20 text-green-700 dark:text-green-400 rounded-lg text-sm font-semibold text-start flex items-center gap-2 border border-green-200 dark:border-green-800">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                <span><?php echo e(__('global.password_updated')); ?></span>
            </div>
        <?php endif; ?>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 flex flex-col items-center text-center h-fit shadow-sm">
                <form id="avatar-form" method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data" class="w-full flex flex-col items-center">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="relative group cursor-pointer mb-4">
                        <img id="avatar-preview"
                             src="<?php echo e($user->avatar ? asset('storage/' . $user->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&color=7F9CF5&background=EBF4FF'); ?>"
                    ...
                    <button type="button" onclick="document.getElementById('avatar-input').click()" class="text-sm font-semibold text-indigo-600 dark:text-indigo-400 hover:underline">
                        <?php echo e(__('global.change_photo')); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <h3 class="text-lg font-bold text-gray-900 dark:text-white mt-4"><?php echo e($user->name); ?></h3>
...
<?php endif; ?>
                        ...
                        <div>
                            <label for="email" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5"><?php echo e(__('global.email')); ?></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 <?php echo e(app()->getLocale() === 'ar' ? 'right-0 pr-3' : 'left-0 pl-3'); ?> flex items-center pointer-events-none text-gray-400">
                                ...
                                <input id="email" name="email" type="email" value="<?php echo e(old('email', $user->email)); ?>" required
                                    class="block w-full <?php echo e(app()->getLocale() === 'ar' ? 'pr-10 pl-4' : 'pl-10 pr-4'); ?> py-3 text-sm text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-900/50 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-0 transition-colors duration-200 placeholder-gray-400 dark:placeholder-gray-500 outline-none hover:border-gray-300 dark:hover:border-gray-600 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-400 dark:border-rose-500 <?php unset($message);
...
<?php endif; ?>
                        ...
                        <div>
                            <label for="phone" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5"><?php echo e(__('global.phone')); ?></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 <?php echo e(app()->getLocale() === 'ar' ? 'right-0 pr-3' : 'left-0 pl-3'); ?> flex items-center pointer-events-none text-gray-400">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                                </div>
                                <input id="phone" name="phone" type="tel" value="<?php echo e(old('phone', $user->phone)); ?>"
                                    class="block w-full <?php echo e(app()->getLocale() === 'ar' ? 'pr-10 pl-4' : 'pl-10 pr-4'); ?> py-3 text-sm text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-900/50 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-0 transition-colors duration-200 placeholder-gray-400 dark:placeholder-gray-500 outline-none hover:border-gray-300 dark:hover:border-gray-600 <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-400 dark:border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="<?php echo e(__('global.phone_example')); ?>" pattern="01[0-9]{9}" maxlength="11">
                            </div>
                            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <div class="flex justify-end pt-2">
                            <button type="submit" class="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 text-white font-bold py-3 px-7 rounded-xl transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                                ...
                                <?php echo e(__('global.save_changes')); ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm hover:shadow-md transition-shadow duration-300 text-start">
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
                        ...
                        <?php echo e(__('global.update_password')); ?>
                    ...
                    <form method="post" action="<?php echo e(route('password.update')); ?>" class="space-y-5">
                        ...
                        <div x-data="{ show: false }">
                            <label for="current_password" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5"><?php echo e(__('global.current_password')); ?></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 <?php echo e(app()->getLocale() === 'ar' ? 'right-0 pr-3' : 'left-0 pl-3'); ?> flex items-center pointer-events-none text-gray-400">
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <button type="button" @click="show = !show" class="absolute inset-y-0 <?php echo e(app()->getLocale() === 'ar' ? 'left-0 pl-3' : 'right-0 pr-3'); ?> flex items-center text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors focus:outline-none">
...
<?php endif; ?>
                        ...
                        <div x-data="{ show: false }">
                            <label for="password" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5"><?php echo e(__('global.new_password')); ?></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 <?php echo e(app()->getLocale() === 'ar' ? 'right-0 pr-3' : 'left-0 pl-3'); ?> flex items-center pointer-events-none text-gray-400">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                                </div>
                                <input id="password" name="password" :type="show ? 'text' : 'password'" autocomplete="new-password" required
                                    class="block w-full <?php echo e(app()->getLocale() === 'ar' ? 'pr-10 pl-10' : 'pl-10 pr-10'); ?> py-3 text-sm text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-900/50 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-0 transition-colors duration-200 placeholder-gray-400 dark:placeholder-gray-500 outline-none hover:border-gray-300 dark:hover:border-gray-600 <?php $__errorArgs = ['password', 'updatePassword'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-400 dark:border-rose-500 <?php unset($message);
...
<?php endif; ?>
                        ...
                        <div x-data="{ show: false }">
                            <label for="password_confirmation" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5"><?php echo e(__('global.confirm_password')); ?></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 <?php echo e(app()->getLocale() === 'ar' ? 'right-0 pr-3' : 'left-0 pl-3'); ?> flex items-center pointer-events-none text-gray-400">
                                ...
                                <input id="password_confirmation" name="password_confirmation" :type="show ? 'text' : 'password'" autocomplete="new-password" required
                                    class="block w-full <?php echo e(app()->getLocale() === 'ar' ? 'pr-10 pl-10' : 'pl-10 pr-10'); ?> py-3 text-sm text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-900/50 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-0 transition-colors duration-200 placeholder-gray-400 dark:placeholder-gray-500 outline-none hover:border-gray-300 dark:hover:border-gray-600 <?php $__errorArgs = ['password_confirmation', 'updatePassword'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-rose-400 dark:border-rose-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="<?php echo e(__('global.password_confirmation_placeholder')); ?>">
                                <button type="button" @click="show = !show" class="absolute inset-y-0 <?php echo e(app()->getLocale() === 'ar' ? 'left-0 pl-3' : 'right-0 pr-3'); ?> flex items-center text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors focus:outline-none">
                                    <svg x-show="!show" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-1.274 4.057-5.065 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                    <svg x-show="show" class="w-5 h-5" style="display:none" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"/></svg>
                                </button>
                ...
                <div class="relative group bg-gradient-to-br from-red-50 to-red-50/30 dark:from-red-950/10 dark:to-red-950/5 rounded-2xl border-2 border-red-200 dark:border-red-900/50 p-6 shadow-sm hover:shadow-md transition-all duration-300 text-start overflow-hidden">
                    ...
                    <div class="relative">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                <h2 class="text-lg font-bold text-red-600 dark:text-red-400"><?php echo e(__('global.delete_account_card')); ?></h2>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1 leading-relaxed"><?php echo e(__('global.delete_account_desc')); ?></p>
                            </div>
                        </div>
                        <div class="mt-5">
                            <button type="button" onclick="toggleDeleteModal(true)" class="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 active:bg-red-800 text-white font-bold py-2.5 px-6 rounded-xl transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                                ...
                                <?php echo e(__('global.delete_account_btn')); ?>
...
<div id="delete-modal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 hidden">
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 max-w-md w-full p-6 shadow-2xl animate-fade-in text-start">
        <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e(__('global.delete_account_confirm_title')); ?></h2>
        <p class="text-sm text-gray-600 dark:text-gray-400 mb-6"><?php echo e(__('global.delete_account_confirm_desc')); ?></p>
        ...
        <form method="post" action="<?php echo e(route('profile.destroy')); ?>">
            ...
            <div class="mb-6">
                <label for="delete_password" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5"><?php echo e(__('global.password')); ?></label>
                <div class="relative">
                    <div class="absolute inset-y-0 <?php echo e(app()->getLocale() === 'ar' ? 'right-0 pr-3' : 'left-0 pl-3'); ?> flex items-center pointer-events-none text-gray-400">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                    </div>
                    <input type="password" id="delete_password" name="password" placeholder="<?php echo e(__('global.password_placeholder')); ?>" required
...
<?php echo $__env->make('layouts.store', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\GH\Desktop\Projects\elegant-store\resources\views/profile/edit.blade.php ENDPATH**/ ?>