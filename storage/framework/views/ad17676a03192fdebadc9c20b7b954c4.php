            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    <p class="text-sm font-bold text-green-800 dark:text-green-300 mb-1">
                        <?php echo e(__('وضع التطوير السريع: ')); ?>

                    </p>
                    <p class="text-xs text-green-700 dark:text-green-400 mb-3 leading-relaxed">
                        <?php echo e(__('لأن المتجر يعمل على جهازك حالياً، قمنا بتوليد الرابط لك مباشرة بدلاً من إرساله للبريد الإلكتروني لتوفير الوقت:')); ?>

                    </p>
                    <a href="<?php echo e(session('dev_reset_link')); ?>" class="inline-block px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-xs font-bold rounded-lg shadow-sm transition">
                        <?php echo e(__('اضغط هنا لتغيير كلمة المرور الآن')); ?> &rarr;
                    </a>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\GH\Desktop\Projects\elegant-store\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>