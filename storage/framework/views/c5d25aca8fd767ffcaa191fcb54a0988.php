...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', __('global.admin_login')); ?> | <?php echo e(config('app.name')); ?></title>
...
<body class="bg-gray-100 dark:bg-gray-950 flex items-center justify-center min-h-screen p-4">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800 p-8">
            <h2 class="text-2xl font-bold mb-2 text-center text-gray-900 dark:text-white"><?php echo e(__('global.admin_dashboard')); ?></h2>
            <p class="text-center text-sm text-gray-500 dark:text-gray-400 mb-6"><?php echo e(__('global.admin_login_enter')); ?></p>
            ...
            <?php if(session('status')): ?>
                <div class="mb-6 bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800/50 rounded-xl p-4 text-start">
                    <p class="text-sm text-green-700 dark:text-green-400"><?php echo e(session('status')); ?></p>
                </div>
            <?php endif; ?>
            ...
            <form method="POST" action="<?php echo e(route('admin.login')); ?>" class="space-y-5">
                <?php echo csrf_field(); ?>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5 text-start"><?php echo e(__('global.email')); ?></label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5 text-start"><?php echo e(__('global.password')); ?></label>
                    <div class="relative">
                        ...
                        <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 <?php echo e(app()->getLocale() === 'ar' ? 'left-0 pr-3' : 'right-0 pr-3'); ?> flex items-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition">
                ...
                <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-xl shadow-lg hover:shadow-indigo-500/25 transition-all duration-300 text-sm">
                    <?php echo e(__('global.admin_login')); ?>
...
<?php /**PATH C:\Users\GH\Desktop\Projects\elegant-store\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>