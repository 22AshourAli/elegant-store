...
@section('content')
{{-- Category Header --}}
<div class="relative overflow-hidden bg-white/40 dark:bg-bg-dark/40 border-b border-slate-200/40 dark:border-slate-800/40 py-6 backdrop-blur-md">
    ...
    <div class="container relative z-10">
        ...
        @if($category->children->count() > 0)
            <div class="flex flex-wrap gap-2.5 mt-4 animate-fadeInUp" role="list" aria-label="Subcategories">
...
<div class="reveal container py-6 flex flex-col md:flex-row gap-6">
    ...
    <div class="hidden md:flex justify-between items-center mb-4 px-4 py-3 bg-white/60 dark:bg-surface-dark/60 rounded-2xl border border-slate-200/40 dark:border-slate-800/40 backdrop-blur-md shadow-[0_8px_32px_0_rgba(31,38,135,0.03)] dark:shadow-[0_8px_32px_0_rgba(0,0,0,0.3)]">
        ...
        @else
            {{-- Empty state --}}
            <div class="bg-white/60 dark:bg-surface-dark/60 rounded-2xl border border-slate-200/40 dark:border-slate-800/40 backdrop-blur-md shadow-sm p-12 text-center">
