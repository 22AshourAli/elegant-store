    ...
    <div class="p-4 text-start bg-white dark:bg-surface-dark">
        ...
        <div class="flex items-center gap-2 mt-4 pt-3 border-t border-slate-100 dark:border-slate-800/60">
            ...
            :aria-label="addingToCart ? '{{ __('global.adding') }}...' : (inCart ? '{{ __('global.added_to_cart') }}' : '{{ __('global.add_to_cart') }}')">
                <svg x-show="!addingToCart" class="w-4.5 sm:w-5 h-4.5 sm:h-5 transition-transform duration-300"
                    :fill="inCart ? 'currentColor' : 'none'"
                    stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path>
                </svg>
                <svg x-show="addingToCart" class="w-4.5 sm:w-5 h-4.5 sm:h-5 animate-spin" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
            </button>
            @endif
            @auth
            <button type="button" @click="
