                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2 hover:opacity-90 transition">
                        ...
                        <div class="flex flex-col items-start">
                            <span class="text-lg font-extrabold tracking-tight text-gray-900 leading-none">ELEGANT</span>
                            <span class="text-[9px] font-semibold tracking-[0.3em] text-indigo-600 leading-none">STORE</span>
                        </div>
                    </a>
                </div>
