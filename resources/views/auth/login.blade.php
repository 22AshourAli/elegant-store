        ...
        <div x-data="{
            ...
            <div class="relative mt-1">
                ...
                <input id="password" name="password" x-model="value" @blur="touched = true" x-bind:type="show ? 'text' : 'password'" required autocomplete="current-password"
                       placeholder="&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;"
                       class="block w-full ps-10 pe-12 rounded-xl border bg-white/70 dark:bg-gray-900/70 text-sm transition-all duration-300 py-2.5 outline-none focus:outline-none focus:ring-4 shadow-sm"
                       :class="error ? 'border-red-450 focus:border-red-500 focus:ring-red-500/10' : (valid && value.length > 0 ? 'border-emerald-450 focus:border-emerald-500 focus:ring-emerald-500/10' : 'border-slate-200 dark:border-slate-800 focus:border-indigo-500 focus:ring-indigo-500/10')">
