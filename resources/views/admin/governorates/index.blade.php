...
@section('page-title', __('global.admin_manage_governorates'))
@section('content')
    ...
    <table class="w-full text-sm">
        ...
        <tbody>
            ...
            <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                <td class="p-3">{{ $gov->id }}</td>
                <td class="p-3">{{ $gov->name }}</td>
                <td class="p-3">
                ...
                <td class="p-3 text-center">
                    ...
                    <form action="{{ route('admin.governorates.destroy', $gov) }}" method="POST" class="inline">
                        @csrf @method('DELETE')
            ...
            @empty
            <tr>
                <td colspan="4" class="p-4 text-center text-gray-500">{{ __('global.admin_no_governorates') }}</td>
            </tr>
            @endforelse
        </tbody>
    </table>
...
<div class="mt-4">{{ $governorates->links() }}</div>
@endif
@endsection
