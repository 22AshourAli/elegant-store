    ...
    <table class="w-full text-sm">
        <thead class="hidden md:table-header-group">
            <tr class="bg-gray-50 dark:bg-gray-700 border-b dark:border-gray-600">
                ...
                <th class="p-3 text-right">{{ __('global.base_shipping_cost') }}</th>
                <th class="p-3 text-right">{{ __('global.cities_count') }}</th>
        ...
        <tbody>
            ...
            <tr class="block md:table-row border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                <td class="block md:table-cell p-3 font-semibold"><span class="md:hidden font-bold text-xs text-gray-500 dark:text-gray-400 block">{{ __('global.admin_name') }}</span>{{ $gov->name }}</td>
                <td class="block md:table-cell p-3"><span class="md:hidden font-bold text-xs text-gray-500 dark:text-gray-400 block">{{ __('global.base_shipping_cost') }}</span>{{ number_format($gov->base_shipping_cost, 2) }} {{ __('global.currency') }}</td>
                <td class="block md:table-cell p-3"><span class="md:hidden font-bold text-xs text-gray-500 dark:text-gray-400 block">{{ __('global.cities_count') }}</span>{{ $gov->cities_count }}</td>
