...
@section('page-title', __('global.admin_add_governorate'))
@section('content')
<div class="bg-white dark:bg-gray-800 rounded shadow p-6 max-w-2xl mx-auto">
    <form action="{{ route('admin.governorates.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="number" step="0.01" min="0" name="base_shipping_cost" required value="{{ old('base_shipping_cost', '0') }}" class="w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white px-3 py-2 border">
