...
<div class="bg-white dark:bg-gray-800 rounded shadow p-6 max-w-2xl mx-auto">
    <form action="{{ route('admin.shipping-settings.update') }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ __('global.fuel_surcharge_hint') }}</p>
        ...
        <div class="mb-6">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ __('global.free_shipping_hint') }}</p>
        ...
        <div class="mb-6">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ __('global.default_shipping_hint') }}</p>
