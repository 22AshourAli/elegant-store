    ...
    <table class="w-full text-sm text-right">
        <thead class="hidden md:table-header-group bg-gray-50 dark:bg-gray-700">
            <tr>
                ...
                <th class="p-3">إجمالي الطلبات</th>
                <th class="p-3">إجمالي الإنفاق</th>
                <th class="p-3">آخر رسالة</th>
                <th class="p-3">آخر إرسال</th>
            ...
            @forelse($customers as $customer)
                ...
                <tr class="block md:table-row border-t dark:border-gray-700">
                    <td class="block md:table-cell p-3">
                        <span class="md:hidden font-bold text-xs text-gray-500 dark:text-gray-400 block">العميل</span>
                    ...
                    <td class="block md:table-cell p-3"><span class="md:hidden font-bold text-xs text-gray-500 dark:text-gray-400 block">إجمالي الطلبات</span>{{ $customer->total_orders }}</td>
                    <td class="block md:table-cell p-3"><span class="md:hidden font-bold text-xs text-gray-500 dark:text-gray-400 block">إجمالي الإنفاق</span>{{ number_format((int) $customer->total_spent) }} ج.م</td>
                    <td class="block md:table-cell p-3 max-w-xs truncate">
                        <span class="md:hidden font-bold text-xs text-gray-500 dark:text-gray-400 block">آخر رسالة</span>
                        @if($log)
                    ...
                    <td class="block md:table-cell p-3 text-xs text-gray-500">
                        <span class="md:hidden font-bold text-xs text-gray-500 dark:text-gray-400 block">آخر إرسال</span>
                        {{ $log ? $log->sent_at?->format('Y-m-d H:i') : '-' }}
                    </td>
                    <td class="block md:table-cell p-3 text-right">
                        <span class="md:hidden font-bold text-xs text-gray-500 dark:text-gray-400 block">الإجراء</span>
