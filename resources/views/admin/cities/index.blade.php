...
@section('page-title', __('global.admin_manage_cities'))
@section('content')
    ...
    <table class="w-full text-sm">
        <thead>
            <tr class="bg-gray-50 dark:bg-gray-700 border-b dark:border-gray-600">
                ...
                <th class="p-3 text-right">{{ __('global.admin_delivery_time') }}</th>
        ...
        <tbody>
            ...
            <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                ...
                <td class="p-3">{{ $city->delivery_time ?? '-' }}</td>
                <td class="p-3">
            ...
            @empty
            <tr>
                <td colspan="6" class="p-4 text-center text-gray-500">{{ __('global.admin_no_cities') }}</td>
            </tr>
            @endforelse
        </tbody>
    </table>
