    ...
    <table class="w-full text-sm">
        <thead>
            <tr class="bg-gray-50 dark:bg-gray-700 border-b dark:border-gray-600">
                ...
                <th class="p-3 text-right hidden md:table-cell">{{ __('global.min_cart_amount') }}</th>
        ...
        <tbody>
            ...
            <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 even:bg-gray-50/50 dark:even:bg-gray-700/20">
                ...
                <td class="p-3 hidden md:table-cell">{{ $rate->min_cart_amount ? (int) $rate->min_cart_amount . ' ' . __('global.currency') : '-' }}</td>
                <td class="p-3">
