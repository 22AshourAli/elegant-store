        ...
        <table class="w-full text-sm">
            <thead>
                <tr class="bg-gray-50 dark:bg-gray-900/50 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <th class="p-3 text-right font-semibold text-gray-600 dark:text-gray-400">{{ __('global.admin_phone') }}</th>
                    <th class="p-3 text-right font-semibold text-gray-600 dark:text-gray-400">{{ __('global.admin_date') }}</th>
                    @if($type === 'staff')
                    <th class="p-3 text-center font-semibold text-gray-600 dark:text-gray-400">{{ __('global.admin_branch') }}</th>
                    @endif
